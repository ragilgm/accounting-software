...
const headCells = [
  ...
  { id: 'handphone', numeric: true, disablePadding: false, label: 'No Handphone' },
  { id: 'telephone', numeric: true, disablePadding: false, label: 'Telephone' },
  { id: 'npwp', numeric: true, disablePadding: false, label: 'NPWP' },
...
const useStyles = makeStyles((theme) => ({
 ...
 export default function TableEmployee(props) {
   ...
   useEffect(() => {
     console.log('====================================');
     console.log("supplier part table");
     console.log('====================================');
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell   onClick={()=>contactInfoHandler(row.id)} component="th" id={labelId} scope="row" padding="none" className="text-primary font-weight-bold">
                        {row.fullname}
                      </TableCell>
