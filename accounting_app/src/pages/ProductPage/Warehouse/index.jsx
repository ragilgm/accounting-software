                     ...
                     <div className="supplier-body mt-5">
                        <div className="row">
                           <div className="header col-lg-4 col-sm-4 my-2 mt-3">
                              <button className="btn button btn-btn-primary" id={productServices} onClick={productServicesHandler}>Warehouse List</button>
                              <button className="btn button btn-btn-primary" id={stockAdjustment} onClick={stockAdjustmentHandler}>Warehouse Transfer List</button>
                           </div>
                              ...
                              {listContact.length === 0 ?
                                 ...
                                 <>
                                    {productServices === "aktif" ?
                                       <>
                                          <ListWarehouse data={SeachData(listContact.contact)} />
                                       </>
                                       :
                                       <>
                                          <WarehouseTransferList data={SeachData(listContact.contact)} />
                                       </>
                                    }
                                 </>
