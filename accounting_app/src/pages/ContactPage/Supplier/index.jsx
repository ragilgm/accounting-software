...
function Supplier(props) {
   ...
   useEffect(() => {
      setLoading(true)
      ContactServices.getContactByType(props.company.id, "supplier")
         .then(res => {
      ...
      setLoading(true)
      ContactGroupServices.getContactGroupByType(props.company.id, "supplier")
         .then(res => {
                  ...
                  <div className="row mt-3">
                     <div className="col-lg-4">
                        <div className=" account-receivable my-2">
                           <h5 className="text-center"> Accounts receivable</h5>
                           <h5 className="text-center"> Rp.500,000,000</h5>
                        </div>
                     </div>
                     <div className="col-lg-4">
                        <div className="accounts-receivable-due my-2">
                           <h5 className="text-center"> Accounts Receivable Due</h5>
                           <h5 className="text-center"> Rp.500,000,000</h5>
                        </div>
                     </div>
                     <div className="col-lg-4">
                        <div className="credit-memo my-2">
                           <h5 className="text-center"> Credit Memo</h5>
                           <h5 className="text-center"> Rp.500,000,000</h5>
                        </div>
                     </div>
                  </div>
                           ...
                           <div className="button-action-import col-lg-6 my-2">
                              <div>
                                 ...
                                 <Dialog
                                    ...
                                    aria-describedby="alert-dialog-description"
                                 >
                                    <DialogTitle id="alert-dialog-title" className="text-center">Import Customer</DialogTitle>
                                    <DialogContent>
                                       <DialogContentText id="alert-dialog-description">
