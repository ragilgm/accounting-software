...
function NewTransferWarehouse(props) {
                                 ...
                                 <div className="col-lg-6 col-sm-10">
                                    <div className="input-group mb-3">
                                       ...
                                       <select name="" id="" className="form-control">
                                          ...
                                          <option value="">Initial Quantity</option>
                              ...
                              <div className="form-group row">
                                 ...
                                 <div className="col-lg-6 col-sm-10">
                                    <div className="input-group mb-3">
                                       ...
                                       <input type="date" className="form-control" id="address" name="address"
...
export default (connect(mapStateToProps, mapDispatchToProps)(NewTransferWarehouse));
