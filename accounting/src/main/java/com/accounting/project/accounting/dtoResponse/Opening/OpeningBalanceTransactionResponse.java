package com.accounting.project.accounting.dtoResponse.Opening;
...
public class OpeningBalanceTransactionResponse {
	private int id;
	...
	public OpeningBalanceTransactionResponse(int id, String transaction_no, String transaction_no_format, String memo,
	...
	public OpeningBalanceTransactionResponse() {
		super();
	}
