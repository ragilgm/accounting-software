...
import TableContactGroup from '../ContactGroup/TableContactGroup'
...
function AllType(props) {
   ...
   useEffect(() => {
      setLoading(true)
      ContactServices.getAllContact(props.company.id)
         .then(res => {
      ...
      setLoading(true)
      ContactGroupServices.getContactGroupByType(props.company.id, "others")
         .then(res => {
            ...
            <div className="tab-pane fade show active" id="customer" role="tabpanel" aria-labelledby="customer-tab">
               <div className="customer-body mt-5">
                  ...
                  <div className="transaction">
                           <div className="btn btn-link text-secondary must-paid" id={musPaid} style={{ fontSize: 16 }} onClick={setMusPainHandler}>Must Be Paid </div> |
                           <div className="btn btn-link text-secondary must-receipt" id={wilReceipt} style={{ fontSize: 16 }} onClick={willPaidHandler}>Must Be Receipt </div>

                        </div>
                     <button className="btn btn-link" style={{fontSize:15}} onClick={handleContactGroupOpen}>Setting Group <i className="fas fa-cogs"></i></button>
                     <Dialog
                     ...
                     >
                        <DialogTitle id="alert-dialog-title" className="text-center font-weight-bold">List Group
                              <div className="my-3">
                  ...
                  <div className="row mt-3">
                     <div className="col-lg-6">
                        <div className=" account-receivable my-2">
                           <h5 className="text-center"> Unpaid Payable</h5>
                           <h5 className="text-center"> Rp.500,000,000</h5>
                        </div>
                     </div>
                     <div className="col-lg-6">
                        <div className="accounts-receivable-due my-2">
                           <h5 className="text-center"> Payable due</h5>
                           <h5 className="text-center"> Rp.500,000,000</h5>
                        </div>
                     </div>
                  </div>
                        ...
                        <div className="col-lg-6">
                           <div className=" account-receivable my-2">
                              <h5 className="text-center"> Unpaid Receivable</h5>
                              <h5 className="text-center"> Rp.500,000,000</h5>
                           </div>
                        </div>
                     </div>
...
export default (connect(mapStateToProps, mapDispatchToProps)(AllType));