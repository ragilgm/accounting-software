...
public class OpeningBalance {
	...
	@OneToMany(cascade = CascadeType.ALL, targetEntity = TransactionAccountLine.class)
	@JoinColumn(name = "opening_balance_id", referencedColumnName = "id")
	...
	public OpeningBalance(String transaction_no, String transaction_no_format, String memo, String transaction_date,
			TransactionStatus transaction_status, List<TransactionAccountLine> transaction_account_lines,
			double total_debit, double total_credit, String total_debit_currency_format,
			String total_credit_currency_format, Date created_at, Date updated_at, String currency_code) {
		super();
