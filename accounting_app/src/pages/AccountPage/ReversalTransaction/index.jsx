...
import ReversalServices from '../../../services/ReversalServices'
...
function ReversalTransaction() {
   ...
   useEffect(() => {
      setLoading(true)
      ReversalServices.getReversalById(id)
         .then(res => {
            console.log(res.data);
            setReversal(res.data);
         ...
         {loading ?
            ...
            <>
               ...
               <div className="header mb-5 row d-flex justify-content-between container-fluid">
                  <div>
                     <h5>Transaction</h5>
                     <h3>Reversal {reversal.transaction_no_format}</h3>
                  </div>
                  <div>
                     Status
               ...
               <div className="body">
                  <div className="row mb-5 mt-5">
                     <div className="col-lg-3">
                        ...
                        <div className="font-weight-bold mt-3">{reversal.transaction_date}</div>
                     </div>
                     <div className="col-lg-3">
                        <div className="font-weight-bold">No Transaction :</div>
                        <div className="font-weight-bold mt-3">{reversal.transaction_no}</div>
                     </div>
                  </div>
                  <hr />
                  <div className="">
                     <div>
                        <div className="col-lg-12 row mt-5">
                           ...
                           <div className="col-lg-2  font-weight-bold">Debit (in {reversal.currency_code})</div>
                           <div className="col-lg-2  font-weight-bold">Credit (in {reversal.currency_code})</div>
                        </div>
                        ...
                        <div className="col-lg-12 row mt-3">
                           ...
                           <div className="col-lg-2  font-weight-bold"></div>
                           <div className="col-lg-4  font-weight-bold"></div>
                           <div className="col-lg-2  font-weight-bold">{reversal.total_debit_currency_format}</div>
                           <div className="col-lg-2  font-weight-bold">{reversal.total_credit_currency_format}</div>
                        </div>
