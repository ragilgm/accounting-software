...
class GraphicDoughnut extends Component {
   constructor(props) {
      super(props);
      this.state = {
         ...
         dataPie: {
            ...
            datasets: [
               {
                  label: ['NUTRICH/EGYPT/SC8602/JEFFRY',"NUTRICH/EGYPT/SC8602/JEFFRY"],
   ...
   render() {
      return (
         <>
            <div class="col-md-6">
               <div class="card">
                  <h5 className="text-center font-weight-bold">Penjualan Hari Ini</h5>
