...
const headCells = [
  ...
  { id: 'From_warehouse', numeric: false, disablePadding: false, label: 'From ' },
  { id: 'to_warehouse', numeric: false, disablePadding: false, label: 'To' },
...
const useStyles = makeStyles((theme) => ({
 ...
 export default function WarehouseTransferList(props) {
