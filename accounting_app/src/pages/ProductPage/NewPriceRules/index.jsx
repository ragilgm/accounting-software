...
function NewPriceRules(props) {
   ...
   const [transferProduct, setTransferProduct] = useState([initialTransfer])
                        ...
                        <div className="form">
                           <form autoComplete="off" >
                              <div className="d-flex justify-content-between">
                                 <div>
                                    <h5>1. Create Rules</h5>
                                    <small>
                                       Set a specific product price rule for the contacts of your choice, according to the period you want. Please fill in the fields below.</small>
                                 </div>
                                 <div>
                              ...
                              <div className="form-group row">
                                 <div className="col-lg-3 mt-5">
                                    <label htmlFor="">Rules Name</label>
                                 ...
                                 <div className="col-lg-3 mt-5">
                                    ...
                                    <select name="" id="" className="form-control">
                                       <option defaultValue="">Choose Persentase</option>
                                       <option value="">Persentage Discount </option>
                                    </select>
                                 </div>
                                 <div className="col-lg-2 mt-5">
                              ...
                              <small>Determine who will get the price rule according to the period.</small>
                              <div className="form-group row">
                                 <table className="table mt-5">
                                    <tr>
                                       <th>Contact name / group</th>
                              ...
                              <div className="d-flex justify-content-between">
                                 <div>
                                      <h5>3. Choose Product</h5>
                                    <small>
                                      Determine what products or services will be subject to the price rule discount.</small>
                                 </div>
                                 <div>
                                    <div className="btn btn-link">
                                       Add Product +
...
export default (connect(mapStateToProps, mapDispatchToProps)(NewPriceRules));
