package com.accounting.project.accounting.dtoResponse.JournalEntry;
...
public class JournalEntryResponse {
	...
	public JournalEntryResponse(int id, String transaction_no, String transaction_no_format, String memo,
			...
			String total_debit_currency_format, String total_credit_currency_format, List<String> attachments,
			boolean locked, boolean reconciled, Date created_at, Date updated_at, String currency_code,
